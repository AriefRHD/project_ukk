...
<body class="bg-gradient-primary">
    ...
    <div class="container">
        ...
        <!-- Outer Row -->
        <div class="row justify-content-center flex my-5" >
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="p-5">
                                    ...
                                    <div class="text-center">
                                        <p class="text-gray-700 mt-3 mb-2">Login Sebagai Siswa</p>
                                    </div>
                                    <form class="user" method="post" action="{{ url('authenticate-siswa') }}">
                                        @csrf
                                        ...
                                        <div class="container btn-user btn-block">
                                            <a href="/login/admin" id="link_login"><p>Login Sebagai Admin / Petugas</p></a>
                                        </div>
                                        </center>
                                </div>
                            </div>
